...
//============================ const ===================	
	...
	int print_Restart = 10000;
	int print_Enrg = 10000; // calc_and_write_amplification
...
//=======================================================
	...
	FILE *surf, *psi_data,  *pfilePhi, *temp, *eta_k;
